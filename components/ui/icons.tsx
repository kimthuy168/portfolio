...
export const RemoveIcon = ({ size = 17 }) => { 
  return (
    <svg
      height={size}
      width={size}
...
export const GoogleIcon = ({ size = 20 }) => {
  return (
    ...
    >
      <path
        fill="#EA4335"
        d="M24 9.5c3.54 0 6.32 1.53 7.77 2.82l5.73-5.73C33.52 3.42 29.11 1.5 24 1.5 14.99 1.5 7.42 7.41 4.61 15.02l6.96 5.41C13.17 14.38 17.94 9.5 24 9.5z"
      />
      <path
        fill="#4285F4"
        d="M46.5 24.5c0-1.44-.13-2.51-.39-3.61H24v7.06h12.77c-.26 1.44-1.68 3.63-4.3 5.07l6.61 5.12c3.86-3.56 6.42-8.82 6.42-13.64z"
      />
      <path
        fill="#FBBC05"
        d="M10.93 28.27a14.61 14.61 0 010-8.54l-6.96-5.41a23.96 23.96 0 000 19.36l6.96-5.41z"
      />
      <path
        fill="#34A853"
        d="M24 46.5c6.52 0 11.98-2.15 15.97-5.87l-6.61-5.12c-1.78 1.17-4.18 1.86-7.36 1.86-6.05 0-11.23-4.88-13.05-11.41l-6.96 5.41C7.42 40.59 14.99 46.5 24 46.5z"
      />
    </svg>
  );
};
export const TelegramIcon = ({ size = 17 }) => {
  return (
    ...
    >
      <path d="M120,0C53.7,0,0,53.7,0,120s53.7,120,120,120s120-53.7,120-120S186.3,0,120,0z M177.4,78.5l-21.9,103.4   c-1.7,7.6-6.2,9.5-12.6,5.9l-34.8-25.7l-16.8,16.2c-1.9,1.9-3.4,3.4-7,3.4l2.5-35.3l64.3-58.2c2.8-2.5-0.6-3.9-4.3-1.4l-79.4,49.9   L45.7,131c-7.4-2.3-7.5-7.4,1.6-11l123.2-47.6C174.1,70.1,178.6,72.9,177.4,78.5z"/>
    </svg>
  );
};
